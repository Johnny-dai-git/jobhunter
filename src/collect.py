"""采集编排器: 跑所有启用的 collectors,把结果落到 DB,自动去重."""
...
def collect_all(config: Config, platforms: Optional[list[str]] = None) -> dict:
    ...
    stats = {"total_new": 0, "total_seen": 0, "by_platform": {}}
    ...
    for platform in platforms:
        ...
        stats["by_platform"][platform] = {"new": new_count, "duplicate": seen_count}
